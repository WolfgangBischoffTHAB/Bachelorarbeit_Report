...
% https://mirror.funkfreundelandshut.de/latex/macros/latex/contrib/koma-script/doc/scrguide-de.pdf
% Seite 289
\usepackage[automark]{scrlayer-scrpage}
\ihead{} % linke Seite (inside) zeigt die zuletzt gesetzte header marker an
\chead{\headmark} % Mitte (center) des headers leer
\ohead{}

\ifoot[]{} % linke Seite footer leer
\cfoot[]{\thepage} % Mitte footer leer
\ofoot[]{} % Rechte seite (output) zeigt Seitezahl
...
\newglossaryentry{AVL}{name={AVL}, description={Application Vector Length}}
\newglossaryentry{SEW}{name={SEW}, description={Selected Element Width}}
\newglossaryentry{LMUL}{name={LMUL}, description={Group Modifier}}
\newglossaryentry{VL}{name={VL}, description={Vector Length}}
\newglossaryentry{IME}{name={IME}, description={Integrated Matrix Extension}}
\newglossaryentry{VME}{name={VME}, description={Vector Matrix Extension}}
\newglossaryentry{AME}{name={AME}, description={Attached Matrix Extension}}
\newglossaryentry{MAC}{name={MAC}, description={Matrix Accumulator}}
%Multiply-Accumulate-Operation \gls{MAC}
\newglossaryentry{CSR}{name={CSR}, description={Control and Status Register}}
\newglossaryentry{LSU}{name={LSU}, description={Load Store Unit}}
...
\lstdefinestyle{PseudoLang}{ %
    ...
    alsoletter={.},
    morekeywords={*,end,vsetvli,vle32.v,vse32.v,vadd.vv,add,sub,slli,bnez,ret},            % if you want to add more keywords to the set
    frame=none,
