...
\ihead{\headmark} % linke Seite (inside) zeigt die zuletzt gesetzte header marker an
\chead{} % Mitte (center) des headers leer
\ohead{}

\ifoot[]{} % linke Seite footer leer
\cfoot[]{} % Mitte footer leer
\ofoot[]{\thepage} % Rechte seite (output) zeigt Seitezahl
