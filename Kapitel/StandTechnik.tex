...
Um die Berechnungen im Kernel herum gibt es weiteren Code, der über Schleifen nacheinander alle Daten in den Kernel lädt, bis die Berechnung vollständig abgeschlossen ist. Es gibt sehr starke Parallelen zwischen dem Strip-Mining und dem Kernel-Ansatz der blis Bibliothek. Sollte blis für RISC-V portiert werden, ist es sinnvoll, dass RISC-V das Prinzip des Strip-Mining ermöglicht. Dies wurde durch die RISC-V Vector Extension für Vektoren bereits erreicht.
