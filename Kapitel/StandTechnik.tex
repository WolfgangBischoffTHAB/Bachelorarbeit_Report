...
RVV fügt einer RISC-V CPU neue Register hinzu. Der Vorteil der \gls{RVV}-Register ist es, dass diese Vektorregister mehrere Elemente parallel auf eine Instruktion hin zusammenrechnen können, anstatt jedes Element einzeln zu berechnen. Der CPU verfährt dann in einem echten \gls{SIMD}-Betriebsmodus (Single Instruction Multiple Data) und spart ein Vielfaches an Taktzyklen im Vergleich zur sequentiellen Ausführung. SIMD bedeutet, dass eine einzige Instruktion mehrere Datensätze auf einmal verarbeitet.
