...
Die Alternative wäre es, ein grundlegend neues Design zu beginnen, welches dann die neuen Anforderungen besser abdeckt. Ein Beispiel für eine neue Anforderung ist es beispielsweise, mehr als einen Speicher-Zugriff parallel durchführen zu können. Die Hardware für die Outer Product Berechnung könnte dann mehrmals synthetisiert werden. Jede Instanz der Outer Product Berechnung könnte möglicherweise über ihren eigenen Zugriff auf den Speicher verfügen. Wenn der Speicher echt-parallel Daten über mehrere Ports gleichzeitig liefern kann, wird eine Matrix-Berechnung parallel statt sequentiell ausführbar.
