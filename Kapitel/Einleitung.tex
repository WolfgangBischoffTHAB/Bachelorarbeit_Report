...
Die ersten verfügbaren Chips waren aufgrund der fehlenden Linzenkosten und einfachen Umsetzbarkeit für wenige Cent verfügbar. Im Jahre 2025 gibt es RISC-V Chips, die erweiterte Funktionen bieten, Desktop-Betriebssysteme und auch LLMs ausführen können.

Die Firma Qualcomm beispielsweise als eines der weltweit führenden Unternehmen auf dem Gebiet der Halbleiter und der Telekommunikation hat eine RISC-V Erweiterung namens Xqci zu RISC-V und auch zu den Compiler-Framework LLVM beigesteuert \cite{phoronix_xqci}. Qualcomm führt auch Käufe von Firmen mit RISC-V Expertise durch. Dies deutet daraufhin, dass Qualcomm den Einsatz von RISC-V in Produkten ernsthaft in Erwägung zieht.
...
Firmen haben diesen Vorteil der KI erkannt und haben vorallem die hohen Lohnkosten menschlicher Arbeit im Blick. Hardware, die \gls{LLM} berechnen kann, wird damit zum relevanten Posten in der Bilanz große Unternehmen. Anstatt fortlaufende Personalkosten zu bezahlen, möchten Unternehmen KI-fähige Hardware einsetzen, die naiv betrachtet nur einmalige Anschaffungskosten verursacht.
...
Die Matrixmultiplikation wird im Kapitel ``Theoretische Grundlagen'' beschrieben. Es wird verdeutlicht, dass sich die Matrixmultiplikation in Teile aufteilen und damit schrittweise abarbeiten lässt.
