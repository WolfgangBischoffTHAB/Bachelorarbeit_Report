...
\caption[View Frustum]{View Frustum (Quelle: \cite{RTR3}, S.94)}
...
\caption[Perspective Projection Matrix]{Perspective Projection Matrix (Quelle: \cite{RTR3}, S. 95)}
...
\caption[Einfaches Neuronales Netz]{Einfaches Neuronales Netz (Quelle: \cite{basic-neural-network-matrix-maths-part-1})}
...
\caption[Mehrere kombinierte Eingaben]{Mehrere kombinierte Eingaben (Quelle: \cite{basic-neural-network-matrix-maths-part-1})}
...
All diese Punkte zusammengenommen ergeben eine große Motivation für den Einsatz von RISC-V und den Einsatz der Matrixmultiplikation innerhalb einer RISC-V-CPU.
