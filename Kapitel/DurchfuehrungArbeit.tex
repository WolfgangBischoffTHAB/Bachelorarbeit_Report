...
Um zu Evaluieren, ob das Design wirklich funktioniert, muss die CPU mit einer Anwengungssoftware betrieben werden, die die neuen Instruktionen wirklich ausführt.
...
\begin{enumerate}
    ...
    \item Analyse der NEORV32 CPU. Es sollen die Komponenten der CPU identifiziert werden mit dem Ziel die Stellen zu finden, die geändert bzw. erweitert werden müssen.
