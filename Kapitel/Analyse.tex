...
Für länger laufende Befehle muss die Execution"=Engine auf den Abschluss der Operation warten. Daher sind lange laufende Operationen jeweils durch ein Paar aus Request- und Response-Zuständen modelliert.

Der Request Zustand wird direkt in Richtung Response"=Zustand verlassen. Der Response"=Zustand wird erst in Richtung EX\_DISPATCH verlassen, wenn das eingehende Response"=Signal aus der Sensitivitätsliste aktiviert worden ist. Im Response"=Zustand werden die erzeugten Daten betrachtet und Signale zurückgesetzt.
