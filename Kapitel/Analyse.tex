...
Die Entität ``CPU--Control'' enthält die Kontrollogik des CPU. Die CPU--Control enthält den Program-Counter der auf die nächste Anweisung zeigt, die ``Control and Status Register'' (\gls{CSR}) und Funktionen für Interrupts und Exceptions.
